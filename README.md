...
<!-- Header -->
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=26&duration=2800&pause=1000&color=00D4FF&center=true&vCenter=true&width=600&lines=Ashutosh+Kumar+Singh;Software+%C2%B7+Embedded+%C2%B7+Robotics" alt="Typing SVG" />
...
|:--------|:-------------|:-----------|
| **Autonomous Mobile Robot** | Full robotic platform — perception, navigation, sim-to-real deployment | ROS2 · Jetson Nano · LiDAR · Gazebo |
| **Music Player Web App** | Browser-based player with playlists and AI-powered recommendations | HTML · CSS · JS · ML |
| **Voting Analysis App** | Election turnout calculation, visualization, and statistical analysis | HTML · CSS · JS · PHP |
| **Gas Leakage Detection** | Real-time embedded detection with automated alerts | ESP · Arduino · Gas/Load Sensors |
